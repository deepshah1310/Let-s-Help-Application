...
class TechnicalRoom extends StatelessWidget {
  final String groupChatId, groupName;

  TechnicalRoom({required this.groupName, required this.groupChatId, Key? key})
      : super(key: key);
  ...
  TextEditingController anydeskValue = TextEditingController();

  void onSend() async {
    Map<String, dynamic> data = {
      "issue": issueValue.text,
      "detail": detailValue.text,
      "anydesk": anydeskValue.text,
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                TextFormField(
                  controller: anydeskValue,
                  decoration: InputDecoration(
                    labelText: 'Enter your AnyDesk ID',
                  ...
                  validator: (value) {
                    if (value!.isEmpty) {
                      return 'Please enter your AnyDesk ID';
                    }
                    return null;
                  },
                ),
